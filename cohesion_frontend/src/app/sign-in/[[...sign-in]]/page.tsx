    ...
    return (
        <div className="flex flex-col items-center">
            <div className="flex flex-col items-center mb-10">
                ...
                <p
                    ref={taglineRef}
                    className="text-sm text-white/55 tracking-wide opacity-0"
                >
                    Log in to visualize your API contracts
                </p>
            </div>
                ...
                <SignIn
                    appearance={{
                        elements: {
                            ...
                            formFieldInput:
                                "bg-[oklch(0.12_0_0)] border-white/10 text-white",
                            footerActionLink: "text-white/60 hover:text-white",
                            dividerLine: "bg-white/10",
                            dividerText: "text-white/30",
                            formButtonPrimary:
                                "bg-white text-[#0a0a0f] hover:bg-white/90 font-medium",
